...
f=THREE.Matrix4.__v1,e=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();if(g.length()===0)g.z=1;f.cross(c,g).normalize();if(f.length()===0){g.x=g.x+1E-4;f.cross(c,g).normalize()}e.cross(g,f);d[0]=f.x;d[4]=e.x;d[8]=g.x;d[1]=f.y;d[5]=e.y;d[9]=g.y;d[2]=f.z;d[6]=e.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,f=this.elements,e=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],n=c[9],m=c[13],q=c[2],p=c[6],o=c[10],r=c[14],t=c[3],v=c[7],w=c[11],c=c[15],s=d[0],B=d[4],
u=d[8],A=d[12],D=d[1],z=d[5],M=d[9],E=d[13],G=d[2],H=d[6],O=d[10],F=d[14],J=d[3],I=d[7],K=d[11],d=d[15];f[0]=e*s+g*D+h*G+i*J;f[4]=e*B+g*z+h*H+i*I;f[8]=e*u+g*M+h*O+i*K;f[12]=e*A+g*E+h*F+i*d;f[1]=j*s+l*D+n*G+m*J;f[5]=j*B+l*z+n*H+m*I;f[9]=j*u+l*M+n*O+m*K;f[13]=j*A+l*E+n*F+m*d;f[2]=q*s+p*D+o*G+r*J;f[6]=q*B+p*z+o*H+r*I;f[10]=q*u+p*M+o*O+r*K;f[14]=q*A+p*E+o*F+r*d;f[3]=t*s+v*D+w*G+c*J;f[7]=t*B+v*z+w*H+c*I;f[11]=t*u+v*M+w*O+c*K;f[15]=t*A+v*E+w*F+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),f=l.dot(l),d=l.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},p=function(i,j,l){var n,o;if(i instanceof a.Particle){n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return l;o={distance:n,point:i.position,face:null,object:i};l.push(o)}else if(i instanceof a.ParticleSystem){var p=i.geometry.vertices,u,A=new a.Matrix4,D=j.origin.clone(),j=j.direction.clone();A.getInverse(i.matrixWorld);A.multiplyVector3(D);A.rotateAxis(j).normalize();
for(A=0;A<p.length;A++){u=p[A];n=m(D,j,u);if(!(n>5)){o={distance:n,point:u.clone(),face:null,object:i,vertex:A};l.push(o)}}}else if(i instanceof a.Mesh){p=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>p)return l;var z=i.geometry,p=z.vertices,M,E,G;M=i.geometry.materials;E=i.material instanceof a.MeshFaceMaterial;var H,O=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);
c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();D=0;for(A=z.faces.length;D<A;D++){o=z.faces[D];n=E===true?M[o.materialIndex]:i.material;if(n!==void 0){G=n.side;f.sub(o.centroid,c);e=o.normal;n=d.dot(e);if(!(Math.abs(n)<O)){u=e.dot(f)/n;if(!(u<0)&&(G===a.DoubleSide||(G===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(u));if(o instanceof a.Face3){n=p[o.a];u=p[o.b];G=p[o.c];if(q(g,n,u,G)){u=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(u);if(!(n<j.near||n>j.far)){o=
{distance:n,point:u,face:o,faceIndex:D,object:i};l.push(o)}}}else if(o instanceof a.Face4){n=p[o.a];u=p[o.b];G=p[o.c];H=p[o.d];if(q(g,n,u,H)||q(g,u,G,H)){u=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(u);if(!(n<j.near||n>j.far)){o={distance:n,point:u,face:o,faceIndex:D,object:i};l.push(o)}}}}}}}}},o=function(a,b,c){for(var a=a.getDescendants(),d=0,f=a.length;d<f;d++)p(a[d],b,c)};a.Ray.prototype.precision=1E-4;a.Ray.prototype.set=function(a,b){this.origin=a;this.direction=b};a.Ray.prototype.intersectObject=
function(a,b){var c=[];b===true&&o(a,this,c);p(a,this,c);c.sort(i);return c};a.Ray.prototype.intersectObjects=function(a,b){for(var c=[],d=0,f=a.length;d<f;d++){p(a[d],this,c);b===true&&o(a[d],this,c)}c.sort(i);return c}})(THREE);
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,j,l=[],n=0,m,q,p=[],o=0,r,t=[],v=0,w,s,B=[],u=0,A,D,z=[],M=0,E={objects:[],sprites:[],lights:[],elements:[]},G=new THREE.Vector3,H=new THREE.Vector4,O=new THREE.Matrix4,F=new THREE.Matrix4,J=new THREE.Frustum,I=new THREE.Vector4,K=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);O.multiply(b.projectionMatrix,b.matrixWorldInverse);O.multiplyVector3(a);return a};this.unprojectVector=
...
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);O.multiply(h.projectionMatrix,h.matrixWorldInverse);J.setFromMatrix(O);e=0;E.objects.length=0;E.sprites.length=0;E.lights.length=0;var wb=function(b){for(var c=0,d=b.children.length;c<d;c++){var e=b.children[c];if(e.visible!==false){if(e instanceof THREE.Light)E.lights.push(e);else if(e instanceof THREE.Mesh||e instanceof THREE.Line){if(e.frustumCulled===false||J.contains(e)===true){f=a();f.object=e;if(e.renderDepth!==null)f.z=
e.renderDepth;else{G.copy(e.matrixWorld.getPosition());O.multiplyVector3(G);f.z=G.z}E.objects.push(f)}}else if(e instanceof THREE.Sprite||e instanceof THREE.Particle){f=a();f.object=e;if(e.renderDepth!==null)f.z=e.renderDepth;else{G.copy(e.matrixWorld.getPosition());O.multiplyVector3(G);f.z=G.z}E.sprites.push(f)}else{f=a();f.object=e;if(e.renderDepth!==null)f.z=e.renderDepth;else{G.copy(e.matrixWorld.getPosition());O.multiplyVector3(G);f.z=G.z}E.objects.push(f)}wb(e)}}};wb(g);n===true&&E.objects.sort(c);
...
Ia;ia++)m.uvs[N][ia]=ja[ia]}}m.material=da;m.z=m.centroidScreen.z;E.elements.push(m)}}}else if(pa instanceof THREE.Line){F.multiply(O,ua);ga=pa.geometry.vertices;N=b();N.positionScreen.copy(ga[0]);F.multiplyVector4(N.positionScreen);ua=pa.type===THREE.LinePieces?2:1;ta=1;for(da=ga.length;ta<da;ta++){N=b();N.positionScreen.copy(ga[ta]);F.multiplyVector4(N.positionScreen);if(!((ta+1)%ua>0)){U=l[j-2];I.copy(N.positionScreen);K.copy(U.positionScreen);if(d(I,K)===true){I.multiplyScalar(1/I.w);K.multiplyScalar(1/
K.w);if(s===u){Ja=new THREE.RenderableLine;B.push(Ja);u++;s++;w=Ja}else w=B[s++];w.v1.positionScreen.copy(I);w.v2.positionScreen.copy(K);w.z=Math.max(I.z,K.z);w.material=pa.material;E.elements.push(w)}}}}}g=0;for(n=E.sprites.length;g<n;g++){pa=E.sprites[g].object;ua=pa.matrixWorld;if(pa instanceof THREE.Particle){H.set(ua.elements[12],ua.elements[13],ua.elements[14],1);O.multiplyVector4(H);H.z=H.z/H.w;if(H.z>0&&H.z<1){if(D===M){ba=new THREE.RenderableParticle;z.push(ba);M++;D++;A=ba}else A=z[D++];
...
j=a.vertices[d];l=g[f];n=g[e];m=g[D];q=i.x-h.x;p=j.x-h.x;o=i.y-h.y;r=j.y-h.y;t=i.z-h.z;v=j.z-h.z;w=n.u-l.u;s=m.u-l.u;B=n.v-l.v;u=m.v-l.v;A=1/(w*u-s*B);E.set((u*q-B*p)*A,(u*o-B*r)*A,(u*t-B*v)*A);G.set((w*p-s*q)*A,(w*r-s*o)*A,(w*v-s*t)*A);z[b].addSelf(E);z[c].addSelf(E);z[d].addSelf(E);M[b].addSelf(G);M[c].addSelf(G);M[d].addSelf(G)}var b,c,d,f,e,g,h,i,j,l,n,m,q,p,o,r,t,v,w,s,B,u,A,D,z=[],M=[],E=new THREE.Vector3,G=new THREE.Vector3,H=new THREE.Vector3,O=new THREE.Vector3,F=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){z[b]=new THREE.Vector3;M[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var J=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){F.copy(e.vertexNormals[d]);f=e[J[d]];D=z[f];H.copy(D);H.subSelf(F.multiplyScalar(F.dot(D))).normalize();
O.cross(e.vertexNormals[d],D);f=O.dot(M[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(H.x,H.y,H.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,n,m,q,p=new THREE.Vector3,o=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,v=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var w=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=w+e[a];j=w+e[a+1];l=w+e[a+2];n=g[i*3];m=g[i*3+1];q=g[i*3+2];p.set(n,m,q);n=g[j*3];m=g[j*3+1];q=g[j*3+2];o.set(n,m,q);n=g[l*3];m=g[l*3+1];q=g[l*3+2];r.set(n,m,q);t.sub(r,o);v.sub(p,
o);t.crossSelf(v);h[i*3]=h[i*3]+t.x;h[i*3+1]=h[i*3+1]+t.y;h[i*3+2]=h[i*3+2]+t.z;h[j*3]=h[j*3]+t.x;h[j*3+1]=h[j*3+1]+t.y;h[j*3+2]=h[j*3+2]+t.z;h[l*3]=h[l*3]+t.x;h[l*3+1]=h[l*3+1]+t.y;h[l*3+2]=h[l*3+2]+t.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];q=h[a+2];c=1/Math.sqrt(n*n+m*m+q*q);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){Y.x=d[a*3];Y.y=d[a*3+1];Y.z=d[a*3+2];$.copy(Y);ba=i[a];K.copy(ba);K.subSelf(Y.multiplyScalar(Y.dot(ba))).normalize();
...
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<e;g++){i[g]=new THREE.Vector3;j[g]=new THREE.Vector3}var l,n,m,q,p,o,r,t,v,w,s,B,u,A,D,e=new THREE.Vector3,g=new THREE.Vector3,z,M,E,G,H,O,F,J=this.offsets;E=0;for(G=J.length;E<G;++E){M=J[E].start;H=J[E].count;var I=J[E].index;z=M;for(M=M+H;z<M;z=z+3){H=I+b[z];O=I+b[z+1];F=I+b[z+2];l=c[H*3];n=c[H*3+1];m=c[H*3+2];q=c[O*3];p=c[O*3+1];o=c[O*3+2];r=c[F*3];
t=c[F*3+1];v=c[F*3+2];w=f[H*2];s=f[H*2+1];B=f[O*2];u=f[O*2+1];A=f[F*2];D=f[F*2+1];q=q-l;l=r-l;p=p-n;n=t-n;o=o-m;m=v-m;B=B-w;w=A-w;u=u-s;s=D-s;D=1/(B*s-w*u);e.set((s*q-u*l)*D,(s*p-u*n)*D,(s*o-u*m)*D);g.set((B*l-w*q)*D,(B*n-w*p)*D,(B*m-w*o)*D);i[H].addSelf(e);i[O].addSelf(e);i[F].addSelf(e);j[H].addSelf(g);j[O].addSelf(g);j[F].addSelf(g)}}var K=new THREE.Vector3,V=new THREE.Vector3,Y=new THREE.Vector3,$=new THREE.Vector3,L,ba,Q;E=0;for(G=J.length;E<G;++E){M=J[E].start;H=J[E].count;I=J[E].index;z=M;
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,j,l,n,m,q,p,o,r,t,v,w,s;function B(a){return a%4?4-a%4:0}function u(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function D(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=I[f*2];f=I[f*2+1];i=I[e*2];j=I[e*2+1];e=I[g*2];l=I[g*2+1];g=O.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
...
O.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function E(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];O.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function G(b,c,d,f){for(var e,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];n=d[f*3+2];i=m[f];var o=J[l*3],p=J[l*3+1];l=J[l*3+2];var q=J[n*3],
r=J[n*3+1];n=J[n*3+2];O.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(J[j*3],J[j*3+1],J[j*3+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(q,r,n)],null,i))}}function H(b,c,d,f){for(var e,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];j=p[f];var q=J[n*3],r=J[n*3+1];n=J[n*3+2];var s=J[m*3],t=J[m*3+1];m=J[m*3+2];var u=J[o*3],v=J[o*3+1];o=J[o*3+2];O.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(J[l*3],J[l*3+1],J[l*3+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(u,v,o)],null,j))}}var O=this,F=0,J=[],I=[],K,V,Y;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(O,d,b);s=a;V=F;b=new Uint8Array(s,V,12);o="";for(v=0;v<12;v++)o=o+String.fromCharCode(b[V+v]);c=u(s,V+12);u(s,V+13);u(s,V+14);u(s,V+15);f=u(s,V+16);i=u(s,V+17);j=u(s,V+18);l=u(s,V+19);n=A(s,V+20);m=A(s,V+20+4);q=A(s,V+20+8);p=A(s,V+20+12);o=A(s,V+20+16);r=A(s,V+20+20);t=
A(s,V+20+24);v=A(s,V+20+28);b=A(s,V+20+32);w=A(s,V+20+36);s=A(s,V+20+40);F=F+c;V=f*3+l;Y=f*4+l;K=p*V;c=o*(V+i*3);f=r*(V+j*3);l=t*(V+i*3+j*3);V=v*Y;i=b*(Y+i*4);j=w*(Y+j*4);Y=F;var F=new Float32Array(a,F,n*3),$,L,ba,Q;for($=0;$<n;$++){L=F[$*3];ba=F[$*3+1];Q=F[$*3+2];O.vertices.push(new THREE.Vector3(L,ba,Q))}n=F=Y+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){F=new Int8Array(a,F,m*3);for(Y=0;Y<m;Y++){$=F[Y*3];L=F[Y*3+1];ba=F[Y*3+2];J.push($/127,L/127,ba/127)}}F=n+m*3*Int8Array.BYTES_PER_ELEMENT;m=F=F+B(m*
3);if(q){F=new Float32Array(a,F,q*2);for(n=0;n<q;n++){Y=F[n*2];$=F[n*2+1];I.push(Y,$)}}q=F=m+q*2*Float32Array.BYTES_PER_ELEMENT;K=q+K+B(p*2);m=K+c+B(o*2);c=m+f+B(r*2);f=c+l+B(t*2);V=f+V+B(v*2);l=V+i+B(b*2);i=l+j+B(w*2);if(r){j=m+r*Uint32Array.BYTES_PER_ELEMENT*3;M(r,m,j+r*Uint32Array.BYTES_PER_ELEMENT*3);D(r,j)}if(t){r=c+t*Uint32Array.BYTES_PER_ELEMENT*3;j=r+t*Uint32Array.BYTES_PER_ELEMENT*3;G(t,c,r,j+t*Uint32Array.BYTES_PER_ELEMENT*3);D(t,j)}if(w){t=l+w*Uint32Array.BYTES_PER_ELEMENT*4;E(w,l,t+w*
Uint32Array.BYTES_PER_ELEMENT*4);z(w,t)}if(s){w=i+s*Uint32Array.BYTES_PER_ELEMENT*4;t=w+s*Uint32Array.BYTES_PER_ELEMENT*4;H(s,i,w,t+s*Uint32Array.BYTES_PER_ELEMENT*4);z(s,t)}p&&M(p,q,q+p*Uint32Array.BYTES_PER_ELEMENT*3);if(o){p=K+o*Uint32Array.BYTES_PER_ELEMENT*3;G(o,K,p,p+o*Uint32Array.BYTES_PER_ELEMENT*3)}v&&E(v,f,f+v*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=V+b*Uint32Array.BYTES_PER_ELEMENT*4;H(b,V,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,j,l,n,m,q,p,o,r,t,v,w=a.faces;q=a.vertices;var s=a.normals,B=a.colors,u=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&u++;for(e=0;e<u;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){j=new THREE.Vector3;j.x=q[c++]*f;j.y=q[c++]*f;j.z=q[c++]*f;d.vertices.push(j)}c=0;for(i=w.length;c<i;){q=w[c++];j=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;l=q&32;p=q&64;q=q&128;if(j){o=new THREE.Face4;o.a=w[c++];o.b=w[c++];o.c=w[c++];o.d=w[c++];j=4}else{o=new THREE.Face3;o.a=w[c++];o.b=w[c++];o.c=w[c++];j=3}if(h){h=w[c++];o.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<u;e++){r=a.uvs[e];m=w[c++];v=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(v,m)}if(g)for(e=0;e<u;e++){r=a.uvs[e];t=[];for(g=0;g<j;g++){m=w[c++];v=r[m*2];m=r[m*2+1];t[g]=new THREE.UV(v,m)}d.faceVertexUvs[e][h]=t}if(n){n=w[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];
...
1];d.skinIndices.push(new THREE.Vector4(w,s,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];B=d.morphTargets[c].vertices;u=a.morphTargets[c].vertices;w=0;for(s=u.length;w<s;w=w+3){q=new THREE.Vector3;q.x=u[w]*f;q.y=u[w+1]*f;q.z=u[w+2]*f;B.push(q)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];s=d.morphColors[c].colors;B=a.morphColors[c].colors;f=0;for(w=B.length;f<w;f=f+3){u=new THREE.Color(16755200);u.setRGB(B[f],B[f+1],B[f+2]);s.push(u)}}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};
...
g[n++];r.materialIndex=t}var u=d.faces.length;if(e)for(e=0;e<l;e++){var A=a.uvs[e],t=g[n++],D=A[t*2],t=A[t*2+1];d.faceUvs[e][u]=new THREE.UV(D,t)}if(v)for(e=0;e<l;e++){for(var A=a.uvs[e],v=[],z=0;z<B;z++){t=g[n++];D=A[t*2];t=A[t*2+1];v[z]=new THREE.UV(D,t)}d.faceVertexUvs[e][u]=v}if(w){w=g[n++]*3;t=new THREE.Vector3;t.x=m[w++];t.y=m[w++];t.z=m[w];r.normal=t}if(p)for(e=0;e<B;e++){w=g[n++]*3;t=new THREE.Vector3;t.x=m[w++];t.y=m[w++];t.z=m[w];r.vertexNormals.push(t)}if(s){p=g[n++];r.color=new THREE.Color(j[p])}if(o)for(e=
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:j+"/"+a}function f(a,b){for(var c in b)if(I.objects[c]===void 0){var d=b[c],e=null;if(d.geometry!==void 0){if(D=I.geometries[d.geometry]){e=false;z=I.materials[d.materials[0]];(e=z instanceof THREE.ShaderMaterial)&&D.computeTangents();v=d.position;w=d.rotation;s=d.quaternion;B=d.scale;r=d.matrix;s=0;d.materials.length===0&&(z=new THREE.MeshFaceMaterial);d.materials.length>1&&(z=new THREE.MeshFaceMaterial);
if(d.morph){e=new THREE.MorphAnimMesh(D,z);if(d.duration!==void 0)e.duration=d.duration;if(d.time!==void 0)e.time=d.time;if(d.mirroredLoop!==void 0)e.mirroredLoop=d.mirroredLoop;z.morphNormals&&D.computeMorphNormals()}else e=new THREE.Mesh(D,z);e.name=c;if(r){e.matrixAutoUpdate=false;e.matrix.set(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])}else{e.position.set(v[0],v[1],v[2]);if(s){e.quaternion.set(s[0],s[1],s[2],s[3]);e.useQuaternion=true}else e.rotation.set(w[0],
w[1],w[2]);e.scale.set(B[0],B[1],B[2])}e.visible=d.visible;e.castShadow=d.castShadow;e.receiveShadow=d.receiveShadow;a.add(e);I.objects[c]=e}}else{v=d.position;w=d.rotation;s=d.quaternion;B=d.scale;s=0;e=new THREE.Object3D;e.name=c;e.position.set(v[0],v[1],v[2]);if(s){e.quaternion.set(s[0],s[1],s[2],s[3]);e.useQuaternion=true}else e.rotation.set(w[0],w[1],w[2]);e.scale.set(B[0],B[1],B[2]);e.visible=d.visible!==void 0?d.visible:false;a.add(e);I.objects[c]=e;I.empties[c]=e}if(e){if(d.properties!==void 0)for(var g in d.properties)e.properties[g]=
d.properties[g];d.children!==void 0&&f(e,d.children)}}}function e(a){return function(b){I.geometries[a]=b;f(I.scene,K.objects);H=H-1;i.onLoadComplete();h()}}function g(a){return function(b){I.geometries[a]=b}}function h(){i.callbackProgress({totalModels:F,totalTextures:J,loadedModels:F-H,loadedTextures:J-O},I);i.onLoadProgress();H===0&&O===0&&b(I)}var i=this,j=THREE.Loader.prototype.extractUrlBase(c),l,n,m,q,p,o,r,t,v,w,s,B,u,A,D,z,M,E,G,H,O,F,J,I,K=a;for(u in this.geometryHandlerMap)this.geometryHandlerMap[u].loaderObject=
new this.geometryHandlerMap[u].loaderClass;O=H=0;I={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(K.transform){a=K.transform.position;c=K.transform.rotation;u=K.transform.scale;a&&I.scene.position.set(a[0],a[1],a[2]);c&&I.scene.rotation.set(c[0],c[1],c[2]);u&&I.scene.scale.set(u[0],u[1],u[2]);if(a||c||u){I.scene.updateMatrix();I.scene.updateMatrixWorld()}}a=function(a){return function(){O=O-a;h();i.onLoadComplete()}};for(q in K.cameras){u=
K.cameras[q];u.type==="perspective"?M=new THREE.PerspectiveCamera(u.fov,u.aspect,u.near,u.far):u.type==="ortho"&&(M=new THREE.OrthographicCamera(u.left,u.right,u.top,u.bottom,u.near,u.far));v=u.position;c=u.target;u=u.up;M.position.set(v[0],v[1],v[2]);M.target=new THREE.Vector3(c[0],c[1],c[2]);u&&M.up.set(u[0],u[1],u[2]);I.cameras[q]=M}for(m in K.lights){c=K.lights[m];q=c.color!==void 0?c.color:16777215;M=c.intensity!==void 0?c.intensity:1;if(c.type==="directional"){v=c.direction;t=new THREE.DirectionalLight(q,
M);t.position.set(v[0],v[1],v[2]);t.position.normalize()}else if(c.type==="point"){v=c.position;t=c.distance;t=new THREE.PointLight(q,M,t);t.position.set(v[0],v[1],v[2])}else c.type==="ambient"&&(t=new THREE.AmbientLight(q));I.scene.add(t);I.lights[m]=t}for(p in K.fogs){m=K.fogs[p];m.type==="linear"?E=new THREE.Fog(0,m.near,m.far):m.type==="exp2"&&(E=new THREE.FogExp2(0,m.density));u=m.color;E.color.setRGB(u[0],u[1],u[2]);I.fogs[p]=E}if(I.cameras&&K.defaults.camera)I.currentCamera=I.cameras[K.defaults.camera];
if(I.fogs&&K.defaults.fog)I.scene.fog=I.fogs[K.defaults.fog];u=K.defaults.bgcolor;I.bgColor=new THREE.Color;I.bgColor.setRGB(u[0],u[1],u[2]);I.bgColorAlpha=K.defaults.bgalpha;for(l in K.geometries){p=K.geometries[l];if(p.type in this.geometryHandlerMap){H=H+1;i.onLoadStart()}}F=H;for(l in K.geometries){p=K.geometries[l];if(p.type==="cube"){D=new THREE.CubeGeometry(p.width,p.height,p.depth,p.segmentsWidth,p.segmentsHeight,p.segmentsDepth,null,p.flipped,p.sides);I.geometries[l]=D}else if(p.type==="plane"){D=
new THREE.PlaneGeometry(p.width,p.height,p.segmentsWidth,p.segmentsHeight);I.geometries[l]=D}else if(p.type==="sphere"){D=new THREE.SphereGeometry(p.radius,p.segmentsWidth,p.segmentsHeight);I.geometries[l]=D}else if(p.type==="cylinder"){D=new THREE.CylinderGeometry(p.topRad,p.botRad,p.height,p.radSegs,p.heightSegs);I.geometries[l]=D}else if(p.type==="torus"){D=new THREE.TorusGeometry(p.radius,p.tube,p.segmentsR,p.segmentsT);I.geometries[l]=D}else if(p.type==="icosahedron"){D=new THREE.IcosahedronGeometry(p.radius,
p.subdivisions);I.geometries[l]=D}else if(p.type in this.geometryHandlerMap){E={};for(G in p)G!=="type"&&G!=="url"&&(E[G]=p[G]);this.geometryHandlerMap[p.type].loaderObject.load(d(p.url,K.urlBaseType),e(l),E)}else if(p.type==="embedded"){p=K.embeds[p.id];p.metadata=K.metadata;p&&this.geometryHandlerMap.ascii.loaderObject.createModel(p,g(l),"")}}for(o in K.textures){l=K.textures[o];if(l.url instanceof Array){O=O+l.url.length;for(G=0;G<l.url.length;G++)i.onLoadStart()}else{O=O+1;i.onLoadStart()}}J=
O;for(o in K.textures){l=K.textures[o];if(l.mapping!==void 0&&THREE[l.mapping]!==void 0)l.mapping=new THREE[l.mapping];if(l.url instanceof Array){p=l.url.length;E=[];for(G=0;G<p;G++)E[G]=d(l.url[G],K.urlBaseType);G=(G=E[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(E,l.mapping,a(p)):THREE.ImageUtils.loadTextureCube(E,l.mapping,a(p))}else{G=l.url.toLowerCase().endsWith(".dds");p=d(l.url,K.urlBaseType);E=a(1);G=G?THREE.ImageUtils.loadCompressedTexture(p,l.mapping,E):THREE.ImageUtils.loadTexture(p,
l.mapping,E);if(THREE[l.minFilter]!==void 0)G.minFilter=THREE[l.minFilter];if(THREE[l.magFilter]!==void 0)G.magFilter=THREE[l.magFilter];if(l.anisotropy)G.anisotropy=l.anisotropy;if(l.repeat){G.repeat.set(l.repeat[0],l.repeat[1]);if(l.repeat[0]!==1)G.wrapS=THREE.RepeatWrapping;if(l.repeat[1]!==1)G.wrapT=THREE.RepeatWrapping}l.offset&&G.offset.set(l.offset[0],l.offset[1]);if(l.wrap){p={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(p[l.wrap[0]]!==void 0)G.wrapS=p[l.wrap[0]];if(p[l.wrap[1]]!==
...
t(o.color);else if(o instanceof THREE.MeshBasicMaterial||o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)if(o.map!==null){if(o.map.mapping instanceof THREE.UVMapping){Xa=j.uvs[0];v(F,J,I,K,V,Y,Xa[g].u,Xa[g].v,Xa[h].u,Xa[h].v,Xa[i].u,Xa[i].v,o.map)}}else if(o.envMap!==null){if(o.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=k.matrixWorldInverse;Da.copy(j.vertexNormalsWorld[g]);ja=(Da.x*a.elements[0]+Da.y*a.elements[4]+Da.z*a.elements[8])*0.5+0.5;pb=(Da.x*
a.elements[1]+Da.y*a.elements[5]+Da.z*a.elements[9])*0.5+0.5;Da.copy(j.vertexNormalsWorld[h]);Oa=(Da.x*a.elements[0]+Da.y*a.elements[4]+Da.z*a.elements[8])*0.5+0.5;Ya=(Da.x*a.elements[1]+Da.y*a.elements[5]+Da.z*a.elements[9])*0.5+0.5;Da.copy(j.vertexNormalsWorld[i]);wb=(Da.x*a.elements[0]+Da.y*a.elements[4]+Da.z*a.elements[8])*0.5+0.5;xb=(Da.x*a.elements[1]+Da.y*a.elements[5]+Da.z*a.elements[9])*0.5+0.5;v(F,J,I,K,V,Y,ja,pb,Oa,Ya,wb,xb,o.envMap)}}else o.wireframe===true?s(o.color,o.wireframeLinewidth,
...
o.wireframeLinecap,o.wireframeLinejoin):t(da)}}function m(a,b,c,d,f,e){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.closePath()}function r(a,b,c,d,f,e,g,h){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.lineTo(g,h);o.closePath()}function s(a,b,c,f){if(u!==b)u=o.lineWidth=b;if(A!==c)A=o.lineCap=c;if(D!==f)D=o.lineJoin=f;d(a.getContextStyle());o.stroke();xa.inflate(b*2)}function t(a){f(a.getContextStyle());o.fill()}function v(a,b,c,d,e,g,h,i,k,j,l,n,m){if(!(m instanceof THREE.DataTexture||
...
z.positionScreen.y);xa.addPoint(M.positionScreen.x,M.positionScreen.y);if(fb.intersects(xa)===true){ca=z;oa=M;b(X.opacity);c(X.blending);o.beginPath();o.moveTo(ca.positionScreen.x,ca.positionScreen.y);o.lineTo(oa.positionScreen.x,oa.positionScreen.y);if(X instanceof THREE.LineBasicMaterial){ca=X.linewidth;if(u!==ca)u=o.lineWidth=ca;ca=X.linecap;if(A!==ca)A=o.lineCap=ca;ca=X.linejoin;if(D!==ca)D=o.lineJoin=ca;d(X.color.getContextStyle());o.stroke();xa.inflate(X.linewidth*2)}}}else if(B instanceof THREE.RenderableFace3){z=
...
E.positionScreen.y);fb.intersects(xa)===true&&n(z,M,E,0,1,2,B,X,a)}else if(B instanceof THREE.RenderableFace4){z=B.v1;M=B.v2;E=B.v3;G=B.v4;z.positionScreen.x=z.positionScreen.x*q;z.positionScreen.y=z.positionScreen.y*p;M.positionScreen.x=M.positionScreen.x*q;M.positionScreen.y=M.positionScreen.y*p;E.positionScreen.x=E.positionScreen.x*q;E.positionScreen.y=E.positionScreen.y*p;G.positionScreen.x=G.positionScreen.x*q;G.positionScreen.y=G.positionScreen.y*p;H.positionScreen.copy(M.positionScreen);O.positionScreen.copy(G.positionScreen);
if(X.overdraw===true){sb(z.positionScreen,M.positionScreen);sb(M.positionScreen,G.positionScreen);sb(G.positionScreen,z.positionScreen);sb(E.positionScreen,H.positionScreen);sb(E.positionScreen,O.positionScreen)}xa.addPoint(z.positionScreen.x,z.positionScreen.y);xa.addPoint(M.positionScreen.x,M.positionScreen.y);xa.addPoint(E.positionScreen.x,E.positionScreen.y);xa.addPoint(G.positionScreen.x,G.positionScreen.y);if(fb.intersects(xa)===true){oa=z;Ea=M;tb=E;jb=G;kb=H;Wb=O;ca=B;B=a;e.info.render.vertices=
...
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(hb){for(var l=0,m=0,n=0,o,p,q,r,s=qc,t=s.directional.colors,v=s.directional.positions,z=s.point.colors,A=s.point.positions,D=s.point.distances,E=s.spot.colors,G=s.spot.positions,I=s.spot.distances,F=s.spot.directions,J=s.spot.angles,K=s.spot.exponents,L=s.hemi.skyColors,U=s.hemi.groundColors,ga=s.hemi.positions,V=0,$=0,ba=0,Y=0,c=o=q=q=p=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;r=j.intensity;p=j.distance;if(j instanceof THREE.AmbientLight)if(Q.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){p=V*3;Q.gammaInput?B(t,p,o,r*r):u(t,p,o,r);Qa.copy(j.matrixWorld.getPosition());Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();v[p]=Qa.x;v[p+1]=Qa.y;v[p+2]=Qa.z;V=V+1}else if(j instanceof THREE.PointLight){q=$*3;Q.gammaInput?B(z,q,o,r*r):u(z,q,o,r);r=j.matrixWorld.getPosition();A[q]=r.x;A[q+
1]=r.y;A[q+2]=r.z;D[$]=p;$=$+1}else if(j instanceof THREE.SpotLight){q=ba*3;Q.gammaInput?B(E,q,o,r*r):u(E,q,o,r);r=j.matrixWorld.getPosition();G[q]=r.x;G[q+1]=r.y;G[q+2]=r.z;I[ba]=p;Qa.copy(r);Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();F[q]=Qa.x;F[q+1]=Qa.y;F[q+2]=Qa.z;J[ba]=Math.cos(j.angle);K[ba]=j.exponent;ba=ba+1}else if(j instanceof THREE.HemisphereLight){p=j.color;q=j.groundColor;o=Y*3;if(Q.gammaInput){r=r*r;B(L,o,p,r);B(U,o,q,r)}else{u(L,o,p,r);u(U,o,q,r)}r=j.matrixWorld.getPosition();
...
c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=c instanceof THREE.CompressedTexture;j=[];for(l=0;l<6;l++)if(Q.autoScaleCubemaps&&!e){m=j;n=l;s=c.image[l];v=Sc;if(!(s.width<=v&&s.height<=v)){z=Math.max(s.width,s.height);t=Math.floor(s.width*v/z);v=Math.floor(s.height*v/z);z=document.createElement("canvas");z.width=t;z.height=v;z.getContext("2d").drawImage(s,0,0,s.width,s.height,0,0,t,v);s=z}m[n]=s}else j[l]=c.image[l];l=j[0];m=(l.width&l.width-1)===0&&(l.height&l.height-
1)===0;n=H(c.format);s=H(c.type);M(k.TEXTURE_CUBE_MAP,c,m);for(l=0;l<6;l++)if(e){v=j[l].mipmaps;z=0;for(A=v.length;z<A;z++){t=v[z];k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,z,n,t.width,t.height,0,t.data)}}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,n,n,s,j[l]);c.generateMipmaps&&m&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(n instanceof
...
i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var s=m,u=void 0,v=void 0,w=void 0,z=void 0,B=void 0,A=void 0,D=void 0,E={},G=s.morphTargets.length,H=s.morphNormals.length;s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++){w=s.faces[u];z=w.materialIndex;A=z!==void 0?z:-1;E[A]===void 0&&(E[A]={hash:A,counter:0});D=E[A].hash+"_"+E[A].counter;s.geometryGroups[D]===void 0&&
(s.geometryGroups[D]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H});B=w instanceof THREE.Face3?3:4;if(s.geometryGroups[D].vertices+B>65535){E[A].counter=E[A].counter+1;D=E[A].hash+"_"+E[A].counter;s.geometryGroups[D]===void 0&&(s.geometryGroups[D]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H})}w instanceof THREE.Face3?s.geometryGroups[D].faces3.push(u):s.geometryGroups[D].faces4.push(u);s.geometryGroups[D].vertices=s.geometryGroups[D].vertices+
B}s.geometryGroupsList=[];var I=void 0;for(I in s.geometryGroups){s.geometryGroups[I].id=Ia++;s.geometryGroupsList.push(s.geometryGroups[I])}}for(l in m.geometryGroups){n=m.geometryGroups[l];if(!n.__webglVertexBuffer){var F=n;F.__webglVertexBuffer=k.createBuffer();F.__webglNormalBuffer=k.createBuffer();F.__webglTangentBuffer=k.createBuffer();F.__webglColorBuffer=k.createBuffer();F.__webglUVBuffer=k.createBuffer();F.__webglUV2Buffer=k.createBuffer();F.__webglSkinIndicesBuffer=k.createBuffer();F.__webglSkinWeightsBuffer=
...
j[q],r,t,v=g.vertexNormals,w=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(o=v.length;h<o;h++){t=v[h].clone();d&&d.multiplyVector3(t);r.vertexNormals.push(t)}r.color.copy(g.color);h=0;for(o=w.length;h<o;h++){t=w[h];r.vertexColors.push(t.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];o=h.id;w=m[o];if(w===void 0){w=
...
0){l=s.clone();l.lerpSelf(h,0.5);j=[s.clone(),l.clone(),w.clone()];h=[l.clone(),h.clone(),w.clone()]}else if(f===1){l=h.clone();l.lerpSelf(w,0.5);j=[s.clone(),h.clone(),l.clone()];h=[l.clone(),w.clone(),s.clone()]}else{l=s.clone();l.lerpSelf(w,0.5);j=[s.clone(),h.clone(),l.clone()];h=[l.clone(),h.clone(),w.clone()]}u[e].push(j,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)u[e].push(a.faceVertexUvs[e][c])}}else{e=f.a;g=f.b;h=f.c;i=f.d;j=a.vertices[e];l=a.vertices[g];n=a.vertices[h];m=
a.vertices[i];q=j.distanceTo(l);p=l.distanceTo(n);o=n.distanceTo(m);r=j.distanceTo(m);if(q>b||p>b||o>b||r>b){t=a.vertices.length;v=a.vertices.length+1;w=f.clone();s=f.clone();if(q>=p&&q>=o&&q>=r||o>=p&&o>=q&&o>=r){q=j.clone();q.lerpSelf(l,0.5);l=n.clone();l.lerpSelf(m,0.5);w.a=e;w.b=t;w.c=v;w.d=i;s.a=t;s.b=g;s.c=h;s.d=v;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);w.vertexNormals[1].copy(e);
w.vertexNormals[2].copy(g);s.vertexNormals[0].copy(e);s.vertexNormals[3].copy(g)}if(f.vertexColors.length===4){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);g=f.vertexColors[2].clone();g.lerpSelf(f.vertexColors[3],0.5);w.vertexColors[1].copy(e);w.vertexColors[2].copy(g);s.vertexColors[0].copy(e);s.vertexColors[3].copy(g)}f=0}else{q=l.clone();q.lerpSelf(n,0.5);l=m.clone();l.lerpSelf(j,0.5);w.a=e;w.b=g;w.c=t;w.d=v;s.a=v;s.b=t;s.c=h;s.d=i;if(f.vertexNormals.length===4){e=f.vertexNormals[1].clone();
...
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){j=a.faceVertexUvs[e][c];s=j[0];h=j[1];w=j[2];j=j[3];if(f===0){l=s.clone();l.lerpSelf(h,0.5);n=w.clone();n.lerpSelf(j,0.5);s=[s.clone(),l.clone(),n.clone(),j.clone()];h=[l.clone(),h.clone(),w.clone(),n.clone()]}else{l=h.clone();l.lerpSelf(w,0.5);n=j.clone();n.lerpSelf(s,0.5);s=[s.clone(),h.clone(),l.clone(),n.clone()];h=[n.clone(),l.clone(),w.clone(),j.clone()]}u[e].push(s,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)u[e].push(a.faceVertexUvs[e][c])}}}a.faces=
B;a.faceVertexUvs=u}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;
...
c+d;l=b[a++]*c;q=b[a++]*c+d;p=b[a++]*c;f.quadraticCurveTo(q,p,i,l);if(g=e[e.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){var v=g/h;THREE.Shape.Utils.b2(v,n,q,i);THREE.Shape.Utils.b2(v,m,p,l)}}break;case "b":i=b[a++]*c+d;l=b[a++]*c;q=b[a++]*c+d;p=b[a++]*-c;o=b[a++]*c+d;r=b[a++]*-c;f.bezierCurveTo(i,l,q,p,o,r);if(g=e[e.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){v=g/h;THREE.Shape.Utils.b3(v,n,q,o,i);THREE.Shape.Utils.b3(v,m,p,r,l)}}}}}return{offset:t.ha*c,path:f}}}};
...
(function(a){var b=function(a){for(var b=a.length,f=0,e=b-1,g=0;g<b;e=g++)f=f+(a[e].x*a[g].y-a[g].x*a[e].y);return f*0.5};a.Triangulate=function(a,d){var f=a.length;if(f<3)return null;var e=[],g=[],h=[],i,j,l;if(b(a)>0)for(j=0;j<f;j++)g[j]=j;else for(j=0;j<f;j++)g[j]=f-1-j;var n=2*f;for(j=f-1;f>2;){if(n--<=0){console.log("Warning, unable to triangulate polygon!");break}i=j;f<=i&&(i=0);j=i+1;f<=j&&(j=0);l=j+1;f<=l&&(l=0);var m;a:{m=a;var q=i,p=j,o=l,r=f,t=g,v=void 0,w=void 0,s=void 0,B=void 0,u=void 0,
A=void 0,D=void 0,z=void 0,M=void 0,w=m[t[q]].x,s=m[t[q]].y,B=m[t[p]].x,u=m[t[p]].y,A=m[t[o]].x,D=m[t[o]].y;if(1E-10>(B-w)*(D-s)-(u-s)*(A-w))m=false;else{for(v=0;v<r;v++)if(!(v==q||v==p||v==o)){var z=m[t[v]].x,M=m[t[v]].y,E=void 0,G=void 0,H=void 0,O=void 0,F=void 0,J=void 0,I=void 0,K=void 0,V=void 0,Y=void 0,$=void 0,L=void 0,E=H=F=void 0,E=A-B,G=D-u,H=w-A,O=s-D,F=B-w,J=u-s,I=z-w,K=M-s,V=z-B,Y=M-u,$=z-A,L=M-D,E=E*Y-G*V,F=F*K-J*I,H=H*L-O*$;if(E>=0&&H>=0&&F>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
THREE.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*e.autoRotateSpeed}function d(a){a.preventDefault();if(v===t.ROTATE){i.set(a.clientX,a.clientY);j.sub(i,h);e.rotateLeft(2*Math.PI*j.x/g*e.userRotateSpeed);e.rotateUp(2*Math.PI*j.y/g*e.userRotateSpeed);h.copy(i)}else if(v===t.ZOOM){n.set(a.clientX,a.clientY);m.sub(n,l);m.y>0?e.zoomIn():e.zoomOut();l.copy(n)}}function f(){if(e.userRotate){document.removeEventListener("mousemove",d,false);document.removeEventListener("mouseup",f,false);
v=t.NONE}}THREE.EventTarget.call(this);this.object=a;this.domElement=b!==void 0?b:document;this.center=new THREE.Vector3;this.userZoom=true;this.userZoomSpeed=1;this.userRotate=true;this.userRotateSpeed=1;this.autoRotate=false;this.autoRotateSpeed=2;var e=this,g=1800,h=new THREE.Vector2,i=new THREE.Vector2,j=new THREE.Vector2,l=new THREE.Vector2,n=new THREE.Vector2,m=new THREE.Vector2,q=0,p=0,o=1,r=new THREE.Vector3,t={NONE:-1,ROTATE:0,ZOOM:1},v=t.NONE,w={type:"change"};this.rotateLeft=function(a){a===
...
if(a.button===0||a.button===2){v=t.ROTATE;h.set(a.clientX,a.clientY)}else if(a.button===1){v=t.ZOOM;l.set(a.clientX,a.clientY)}document.addEventListener("mousemove",d,false);document.addEventListener("mouseup",f,false)}},false);this.domElement.addEventListener("mousewheel",function(a){e.userZoom&&(a.wheelDelta>0?e.zoomOut():e.zoomIn())},false)};
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,l,m){var n,o=d||1,p=f||1,q=h/2,r=i/2,t=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var v=o+1,w=p+1,Y=h/o,$=i/p,L=new THREE.Vector3;L[n]=l>0?1:-1;for(h=0;h<w;h++)for(i=0;i<v;i++){var ba=new THREE.Vector3;ba[a]=(i*Y-q)*c;ba[b]=(h*$-r)*g;ba[n]=l;j.vertices.push(ba)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
v*h+t,i+v*(h+1)+t,i+1+v*(h+1)+t,i+1+v*h+t);a.normal.copy(L);a.vertexNormals.push(L.clone(),L.clone(),L.clone(),L.clone());a.materialIndex=m;j.faces.push(a);j.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var j=this,l=a/2,n=b/2,m=c/2,q,p,o,r,t,v;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(q=0;q<6;q++)this.materials.push(g)}q=0;r=1;p=2;t=3;o=4;v=
5}else this.materials=[];this.sides={px:true,nx:true,py:true,ny:true,pz:true,nz:true};if(h!=void 0)for(var w in h)this.sides[w]!==void 0&&(this.sides[w]=h[w]);this.sides.px&&i("z","y",-1,-1,c,b,l,q);this.sides.nx&&i("z","y",1,-1,c,b,-l,r);this.sides.py&&i("x","z",1,1,a,c,n,p);this.sides.ny&&i("x","z",1,-1,a,c,-n,t);this.sides.pz&&i("x","y",1,-1,a,b,m,o);this.sides.nz&&i("x","y",-1,-1,a,b,-m,v);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
this.vertices[j[0][h+1]].clone()}else{n=this.vertices[j[1][h]].clone();m=this.vertices[j[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var q=j[i][h],p=j[i+1][h],o=j[i+1][h+1],r=j[i][h+1],t=n.clone(),v=n.clone(),w=m.clone(),s=m.clone(),B=l[i][h].clone(),u=l[i+1][h].clone(),A=l[i+1][h+1].clone(),D=l[i][h+1].clone();this.faces.push(new THREE.Face4(q,p,o,r,[t,v,w,s]));this.faceVertexUvs[0].push([B,u,A,D])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){q=j[0][h];p=j[0][h+1];o=this.vertices.length-1;t=new THREE.Vector3(0,1,0);v=new THREE.Vector3(0,1,0);w=new THREE.Vector3(0,1,0);B=l[0][h].clone();u=l[0][h+1].clone();A=new THREE.UV(u.u,0);this.faces.push(new THREE.Face3(q,p,o,[t,v,w]));this.faceVertexUvs[0].push([B,u,A])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){q=j[i][h+1];p=j[i][h];o=this.vertices.length-1;t=new THREE.Vector3(0,-1,0);v=new THREE.Vector3(0,
-1,0);w=new THREE.Vector3(0,-1,0);B=l[i][h+1].clone();u=l[i][h].clone();A=new THREE.UV(u.u,1);this.faces.push(new THREE.Face3(q,p,o,[t,v,w]));this.faceVertexUvs[0].push([B,u,A])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=m+l*2,g=0;g<h;g++){var i=V*g,j=V*(g+1),n=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,r=h,s=e,u=f,n=n+E,i=i+E,o=o+E,j=j+E;M.faces.push(new THREE.Face4(n,i,o,j,null,null,t));n=v.generateSideWallUV(M,a,p,b,n,i,o,j,q,r,s,u);M.faceVertexUvs[0].push(n)}}}function e(a,b,c){M.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+E;d=d+E;e=e+E;M.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?v.generateBottomUV(M,a,b,c,d,e):v.generateTopUV(M,a,b,c,d,e);M.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,j=b.bevelSize!==void 0?b.bevelSize:i-2,l=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,q=b.extrudePath,p,o=false,r=b.material,t=b.extrudeMaterial,v=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,w,s,B,u;if(q){p=q.getSpacedPoints(m);o=true;n=false;w=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(q,m,
false);s=new THREE.Vector3;B=new THREE.Vector3;u=new THREE.Vector3}if(!n)j=i=l=0;var A,D,z,M=this,E=this.vertices.length,q=a.extractPoints(),G=q.shape,q=q.holes,H=!THREE.Shape.Utils.isClockWise(G);if(H){G=G.reverse();D=0;for(z=q.length;D<z;D++){A=q[D];THREE.Shape.Utils.isClockWise(A)&&(q[D]=A.reverse())}H=false}var O=THREE.Shape.Utils.triangulateShape(G,q),H=G;D=0;for(z=q.length;D<z;D++){A=q[D];G=G.concat(A)}var F,J,I,K,V=G.length,Y=O.length,$=[],L=0,ba=H.length;F=ba-1;for(J=L+1;L<ba;L++,F++,J++){F===
ba&&(F=0);J===ba&&(J=0);$[L]=d(H[L],H[F],H[J])}var Q=[],fa,ta=$.concat();D=0;for(z=q.length;D<z;D++){A=q[D];fa=[];L=0;ba=A.length;F=ba-1;for(J=L+1;L<ba;L++,F++,J++){F===ba&&(F=0);J===ba&&(J=0);fa[L]=d(A[L],A[F],A[J])}Q.push(fa);ta=ta.concat(fa)}for(F=0;F<l;F++){A=F/l;I=i*(1-A);J=j*Math.sin(A*Math.PI/2);L=0;for(ba=H.length;L<ba;L++){K=c(H[L],$[L],J);e(K.x,K.y,-I)}D=0;for(z=q.length;D<z;D++){A=q[D];fa=Q[D];L=0;for(ba=A.length;L<ba;L++){K=c(A[L],fa[L],J);e(K.x,K.y,-I)}}}J=j;for(L=0;L<V;L++){K=n?c(G[L],
ta[L],J):G[L];if(o){B.copy(w.normals[0]).multiplyScalar(K.x);s.copy(w.binormals[0]).multiplyScalar(K.y);u.copy(p[0]).addSelf(B).addSelf(s);e(u.x,u.y,u.z)}else e(K.x,K.y,0)}for(A=1;A<=m;A++)for(L=0;L<V;L++){K=n?c(G[L],ta[L],J):G[L];if(o){B.copy(w.normals[A]).multiplyScalar(K.x);s.copy(w.binormals[A]).multiplyScalar(K.y);u.copy(p[A]).addSelf(B).addSelf(s);e(u.x,u.y,u.z)}else e(K.x,K.y,h/m*A)}for(F=l-1;F>=0;F--){A=F/l;I=i*(1-A);J=j*Math.sin(A*Math.PI/2);L=0;for(ba=H.length;L<ba;L++){K=c(H[L],$[L],J);
e(K.x,K.y,h+I)}D=0;for(z=q.length;D<z;D++){A=q[D];fa=Q[D];L=0;for(ba=A.length;L<ba;L++){K=c(A[L],fa[L],J);o?e(K.x,K.y+p[m-1].y,p[m-1].x+I):e(K.x,K.y,h+I)}}}if(n){i=V*0;for(L=0;L<Y;L++){h=O[L];g(h[2]+i,h[1]+i,h[0]+i,true)}i=V*(m+l*2);for(L=0;L<Y;L++){h=O[L];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(L=0;L<Y;L++){h=O[L];g(h[2],h[1],h[0],true)}for(L=0;L<Y;L++){h=O[L];g(h[0]+V*m,h[1]+V*m,h[2]+V*m,false)}}h=0;f(H,h);h=h+H.length;D=0;for(z=q.length;D<z;D++){A=q[D];f(A,h);h=h+A.length}};
...
1-p))}j.push(n);l.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=j[i][h+1],f=j[i][h],e=j[i+1][h],g=j[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[f].clone().normalize(),q=this.vertices[e].clone().normalize(),p=this.vertices[g].clone().normalize(),o=l[i][h+1].clone(),r=l[i][h].clone(),t=l[i+1][h].clone(),v=l[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,e,g,[n,q,p]));this.faceVertexUvs[0].push([o,t,v])}else if(Math.abs(this.vertices[e].y)==
a){this.faces.push(new THREE.Face3(d,f,e,[n,m,q]));this.faceVertexUvs[0].push([o,r,t])}else{this.faces.push(new THREE.Face4(d,f,e,g,[n,m,q,p]));this.faceVertexUvs[0].push([o,r,t,v])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
[],i=[],j=[],l=this,n=a.vertices,m=a.faces,h=n.concat(),q=[],p={},o={},r={},t=n.length,v,w,s,B,u,A=a.faceVertexUvs[0];b("originalFaces, uvs, originalVerticesLength",m.length,A.length,t);if(l.supportUVs){v=0;for(w=A.length;v<w;v++){s=0;for(B=A[v].length;s<B;s++){u=m[v]["abcd".charAt(s)];g(u,v,A[v][s])}}}if(A.length==0)l.supportUVs=false;v=0;for(var D in r)v++;if(!v){l.supportUVs=false;b("no uvs")}b("-- Original Faces + Vertices UVs completed",r,"vs",A.length);var z;v=0;for(w=m.length;v<w;v++){u=m[v];
q.push(u.centroid);h.push(u.centroid);if(l.supportUVs){z=new THREE.UV;if(u instanceof THREE.Face3){z.u=e(u.a,v).u+e(u.b,v).u+e(u.c,v).u;z.v=e(u.a,v).v+e(u.b,v).v+e(u.c,v).v;z.u=z.u/3;z.v=z.v/3}else if(u instanceof THREE.Face4){z.u=e(u.a,v).u+e(u.b,v).u+e(u.c,v).u+e(u.d,v).u;z.v=e(u.a,v).v+e(u.b,v).v+e(u.c,v).v+e(u.d,v).v;z.u=z.u/4;z.v=z.v/4}g(t+v,"",z)}}b("-- added UVs for new Faces",r);D=function(a,b){M[a]===void 0&&(M[a]=[]);M[a].push(b)};var M={},A=0;for(w=a.faces.length;A<w;A++){u=a.faces[A];
if(u instanceof THREE.Face3){z=f(u.a,u.b);D(z,A);z=f(u.b,u.c);D(z,A);z=f(u.c,u.a);D(z,A)}else if(u instanceof THREE.Face4){z=f(u.a,u.b);D(z,A);z=f(u.b,u.c);D(z,A);z=f(u.c,u.d);D(z,A);z=f(u.d,u.a);D(z,A)}}w=M;var E=0,G,H;D={};A={};for(v in w){z=w[v];G=v.split("_");H=G[0];G=G[1];s=H;u=[H,G];D[s]===void 0&&(D[s]=[]);D[s].push(u);s=G;u=[H,G];D[s]===void 0&&(D[s]=[]);D[s].push(u);s=0;for(B=z.length;s<B;s++){u=z[s];var O=H,F=u,J=v;A[O]===void 0&&(A[O]={});A[O][F]=J;O=G;F=v;A[O]===void 0&&(A[O]={});A[O][u]=
F}z.length<2&&(o[v]=true)}b("vertexEdgeMap",D,"vertexFaceMap",A);for(v in w){z=w[v];u=z[0];B=z[1];G=v.split("_");H=G[0];G=G[1];z=new THREE.Vector3;if(o[v]){z.addSelf(n[H]);z.addSelf(n[G]);z.multiplyScalar(0.5)}else{z.addSelf(q[u]);z.addSelf(q[B]);z.addSelf(n[H]);z.addSelf(n[G]);z.multiplyScalar(0.25)}p[v]=t+m.length+E;h.push(z);E++;if(l.supportUVs){z=new THREE.UV;z.u=e(H,u).u+e(G,u).u;z.v=e(H,u).v+e(G,u).v;z.u=z.u/2;z.v=z.v/2;g(p[v],u,z);if(!o[v]){z=new THREE.UV;z.u=e(H,B).u+e(G,B).u;z.v=e(H,B).v+
e(G,B).v;z.u=z.u/2;z.v=z.v/2;g(p[v],B,z)}}}b("-- Step 2 done");var I,K;G=["123","12","2","23"];B=["123","23","3","31"];var O=["123","31","1","12"],F=["1234","12","2","23"],J=["1234","23","3","34"],V=["1234","34","4","41"],Y=["1234","41","1","12"];v=0;for(w=q.length;v<w;v++){u=m[v];z=t+v;if(u instanceof THREE.Face3){E=f(u.a,u.b);H=f(u.b,u.c);I=f(u.c,u.a);d(z,p[E],u.b,p[H],u,G,v);d(z,p[H],u.c,p[I],u,B,v);d(z,p[I],u.a,p[E],u,O,v)}else if(u instanceof THREE.Face4){E=f(u.a,u.b);H=f(u.b,u.c);I=f(u.c,u.d);
K=f(u.d,u.a);d(z,p[E],u.b,p[H],u,F,v);d(z,p[H],u.c,p[I],u,J,v);d(z,p[I],u.d,p[K],u,V,v);d(z,p[K],u.a,p[E],u,Y,v)}else b("face should be a face!",u)}p=new THREE.Vector3;u=new THREE.Vector3;v=0;for(w=n.length;v<w;v++)if(D[v]!==void 0){p.set(0,0,0);u.set(0,0,0);H=new THREE.Vector3(0,0,0);z=0;for(s in A[v]){p.addSelf(q[s]);z++}G=0;E=D[v].length;for(s=0;s<E;s++)o[f(D[v][s][0],D[v][s][1])]&&G++;if(G!=2){p.divideScalar(z);for(s=0;s<E;s++){z=D[v][s];z=n[z[0]].clone().addSelf(n[z[1]]).divideScalar(2);u.addSelf(z)}u.divideScalar(E);
H.addSelf(n[v]);H.multiplyScalar(E-3);H.addSelf(p);H.addSelf(u.multiplyScalar(2));H.divideScalar(E);h[v]=H}}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");q=false};this.render=function(a,d,f,t){var a=a.__webglFlares,v=a.length;if(v){var w=new THREE.Vector3,s=t/f,B=f*0.5,u=t*0.5,A=16/t,D=new THREE.Vector2(A*s,A),z=new THREE.Vector3(1,1,0),M=new THREE.Vector2(1,1),E=m,A=n;b.useProgram(l);if(!q){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);q=true}b.uniform1i(E.occlusionMap,0);b.uniform1i(E.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(A.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var G,H,O,F,J;for(G=0;G<v;G++){A=16/t;D.set(A*s,A);F=a[G];w.set(F.matrixWorld.elements[12],F.matrixWorld.elements[13],F.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(w);d.projectionMatrix.multiplyVector3(w);z.copy(w);M.x=z.x*B+B;M.y=z.y*u+u;if(j||M.x>0&&M.x<f&&M.y>0&&
...
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);F.positionScreen.copy(z);F.customUpdateCallback?F.customUpdateCallback(F):F.updateLensFlares();b.uniform1i(E.renderType,2);b.enable(b.BLEND);H=0;for(O=F.lensFlares.length;H<O;H++){J=F.lensFlares[H];if(J.opacity>0.001&&J.scale>0.001){z.x=J.x;z.y=J.y;z.z=J.z;A=J.size*J.scale/t;D.x=A*s;D.y=A;b.uniform3f(E.screenPosition,z.x,z.y,z.z);b.uniform2f(E.scale,D.x,D.y);b.uniform1f(E.rotation,J.rotation);b.uniform1f(E.opacity,J.opacity);
...
vertexShader:g.vertexShader,uniforms:h,skinning:true});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:true,skinning:true});c._shadowPass=true;d._shadowPass=true;f._shadowPass=true;e._shadowPass=true};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,n){var m,q,p,o,r,t,v,w,s,B=[];o=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(true);m=0;for(q=l.__lights.length;m<q;m++){p=l.__lights[m];if(p.castShadow)if(p instanceof THREE.DirectionalLight&&p.shadowCascade)for(r=0;r<p.shadowCascadeCount;r++){var u;if(p.shadowCascadeArray[r])u=p.shadowCascadeArray[r];else{s=p;v=r;u=new THREE.DirectionalLight;u.isVirtual=true;u.onlyShadow=true;u.castShadow=true;u.shadowCameraNear=s.shadowCameraNear;u.shadowCameraFar=s.shadowCameraFar;u.shadowCameraLeft=s.shadowCameraLeft;u.shadowCameraRight=
s.shadowCameraRight;u.shadowCameraBottom=s.shadowCameraBottom;u.shadowCameraTop=s.shadowCameraTop;u.shadowCameraVisible=s.shadowCameraVisible;u.shadowDarkness=s.shadowDarkness;u.shadowBias=s.shadowCascadeBias[v];u.shadowMapWidth=s.shadowCascadeWidth[v];u.shadowMapHeight=s.shadowCascadeHeight[v];u.pointsWorld=[];u.pointsFrustum=[];w=u.pointsWorld;t=u.pointsFrustum;for(var A=0;A<8;A++){w[A]=new THREE.Vector3;t[A]=new THREE.Vector3}w=s.shadowCascadeNearZ[v];s=s.shadowCascadeFarZ[v];t[0].set(-1,-1,w);
t[1].set(1,-1,w);t[2].set(-1,1,w);t[3].set(1,1,w);t[4].set(-1,-1,s);t[5].set(1,-1,s);t[6].set(-1,1,s);t[7].set(1,1,s);u.originalCamera=n;t=new THREE.Gyroscope;t.position=p.shadowCascadeOffset;t.add(u);t.add(u.target);n.add(t);p.shadowCascadeArray[r]=u;console.log("Created virtualLight",u)}v=p;w=r;s=v.shadowCascadeArray[w];s.position.copy(v.position);s.target.position.copy(v.target.position);s.lookAt(s.target);s.shadowCameraVisible=v.shadowCameraVisible;s.shadowDarkness=v.shadowDarkness;s.shadowBias=
v.shadowCascadeBias[w];t=v.shadowCascadeNearZ[w];v=v.shadowCascadeFarZ[w];s=s.pointsFrustum;s[0].z=t;s[1].z=t;s[2].z=t;s[3].z=t;s[4].z=v;s[5].z=v;s[6].z=v;s[7].z=v;B[o]=u;o++}else{B[o]=p;o++}}m=0;for(q=B.length;m<q;m++){p=B[m];if(!p.shadowMap){p.shadowMap=new THREE.WebGLRenderTarget(p.shadowMapWidth,p.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});p.shadowMapSize=new THREE.Vector2(p.shadowMapWidth,p.shadowMapHeight);p.shadowMatrix=new THREE.Matrix4}if(!p.shadowCamera){if(p instanceof
...
if(!r._viewMatrixArray)r._viewMatrixArray=new Float32Array(16);if(!r._projectionMatrixArray)r._projectionMatrixArray=new Float32Array(16);r.matrixWorldInverse.flattenToArray(r._viewMatrixArray);r.projectionMatrix.flattenToArray(r._projectionMatrixArray);h.multiply(r.projectionMatrix,r.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(o);b.clear();s=l.__webglObjects;p=0;for(o=s.length;p<o;p++){v=s[p];t=v.object;v.render=false;if(t.visible&&t.castShadow&&(!(t instanceof THREE.Mesh)||!t.frustumCulled||
g.contains(t))){t._modelViewMatrix.multiply(r.matrixWorldInverse,t.matrixWorld);v.render=true}}p=0;for(o=s.length;p<o;p++){v=s[p];if(v.render){t=v.object;v=v.buffer;w=t.customDepthMaterial?t.customDepthMaterial:t instanceof THREE.SkinnedMesh?t.geometry.morphTargets.length?e:f:t.geometry.morphTargets.length?d:c;v instanceof THREE.BufferGeometry?b.renderBufferDirect(r,l.__lights,null,w,v,t):b.renderBuffer(r,l.__lights,null,w,v,t)}}s=l.__webglObjectsImmediate;p=0;for(o=s.length;p<o;p++){v=s[p];t=v.object;
...
j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=false};this.render=function(d,f,q,p){var d=d.__webglSprites,o=d.length;if(o){var r=i,t=j,v=p/q,q=q*0.5,w=p*0.5,s=true;b.useProgram(h);if(!l){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);l=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(t.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(t.map,0);for(var B,u=[],r=0;r<o;r++){B=d[r];if(B.visible&&B.opacity!==0)if(B.useScreenCoordinates)B.z=-B.position.z;else{B._modelViewMatrix.multiply(f.matrixWorldInverse,B.matrixWorld);B.z=-B._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<o;r++){B=d[r];if(B.visible&&B.opacity!==0&&B.map&&B.map.image&&B.map.image.width){if(B.useScreenCoordinates){b.uniform1i(t.useScreenCoordinates,1);
b.uniform3f(t.screenPosition,(B.position.x-q)/q,(w-B.position.y)/w,Math.max(0,Math.min(1,B.position.z)))}else{b.uniform1i(t.useScreenCoordinates,0);b.uniform1i(t.affectedByDistance,B.affectedByDistance?1:0);b.uniformMatrix4fv(t.modelViewMatrix,false,B._modelViewMatrix.elements)}f=B.map.image.width/(B.scaleByViewport?p:1);u[0]=f*v*B.scale.x;u[1]=f*B.scale.y;b.uniform2f(t.uvScale,B.uvScale.x,B.uvScale.y);b.uniform2f(t.uvOffset,B.uvOffset.x,B.uvOffset.y);b.uniform2f(t.alignment,B.alignment.x,B.alignment.y);
b.uniform1f(t.opacity,B.opacity);b.uniform3f(t.color,B.color.r,B.color.g,B.color.b);b.uniform1f(t.rotation,B.rotation);b.uniform2fv(t.scale,u);if(B.mergeWith3D&&!s){b.enable(b.DEPTH_TEST);s=true}else if(!B.mergeWith3D&&s){b.disable(b.DEPTH_TEST);s=false}c.setBlending(B.blending,B.blendEquation,B.blendSrc,B.blendDst);c.setTexture(B.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
